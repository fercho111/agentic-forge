          ...
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              ...
              <p className="text-gray-600">
                Convierte una idea de software en una primera especificación
                técnica utilizando un pipeline mínimo de múltiples agentes.
              </p>
              <p className="text-sm text-gray-500">
                Sesión iniciada como: {userEmail ?? "Usuario autenticado"}
              </p>
            </div>
            ...
            <button
              ...
              disabled={loggingOut}
              className="rounded-md border bg-white px-4 py-2 text-sm text-gray-700 shadow-sm disabled:opacity-50"
            >
